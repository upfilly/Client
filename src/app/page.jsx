  ...
  const testimonials = [
    {
      ...
      feedback: "I am really impressed with the quality of service. The product exceeded my expectations. Highly recommend!",
      image: "/assets/img/person.jpg",
    },
    {
      name: "Jane Smith",
      location: "London, UK",
      feedback: "The experience was great! I received prompt support and the product is fantastic. Definitely would buy again.",
      image: "/assets/img/person.jpg",
    },
    {
      name: "Michael Brown",
      location: "Sydney, Australia",
      feedback: "Amazing customer service! My issues were resolved quickly, and the product works perfectly. Couldn't ask for more.",
      image: "/assets/img/person.jpg",
    },
  ];
    ...
    <Layout handleKeyPress={undefined} setFilter={undefined} reset={undefined} filter={undefined} name={undefined} filters={undefined}>
          ...
          <div className="row align-items-center flex-lg-row flex-column-reverse  flex-md-row ">
            <div className="col-md-6 ">
              <div className='pl_section ' >
                ...
                <p className='desc'>Track performance, manage campaigns, and scale your affiliate network effortlessly. Plus, let our experts handle it all for you with our Managed Subscription service.</p>
      ...
      <div className="container ">
        <div className="my-5 mobile-pl ">
          <div className="row">
            <div className="col-md-12 text-center mt-5 mb-0">
              <h2 className='leading_heading'>More Than Just an Affiliate Network</h2>
        ...
        <div className="row">
          ...
          <div className="col-12 col-sm-12 col-md-6 col-lg-4">
            <div className="bg_blue p-4  mb-4">
              ...
              <ul className='tool_list set_tool_list'>
                ...
                <li>
                  <img src="/assets/img/checkmark.png" className='chckrk' alt="" />
                  Make you business more flexible
                </li>
              </ul>
            </div>
          </div>
          <div className="col-12 col-sm-12 col-md-6 col-lg-4">
            <div className="bg_blue p-4 mb-4 ">
              <h4 className='affiliatebx' >Affiliate<br />Tracking</h4>
              <p className='text-white para_affiliate'>Showcase the UpFilly dashboard highlighting performance metrics .</p>
          ...
          <div className="col-12 col-sm-12 col-md-6 col-lg-4">
            <div className="bg_blue p-4 mb-4 ">
              <h4 className='affiliatebx' >Performance<br />Insights</h4>
              <p className='text-white para_affiliate'>Data-driven analytics to optimize your campaigns.</p>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-6">
              <div className="bg-white text-black p-4 ">
                ...
                <p className='mt-4 mb-4 pb-4 border-bottom'>I am really impressed with the quality of service. The product exceeded my expectations. Highly recommend!</p>
                <div className="d-flex align-items-center">
                  <img src='/assets/img/person.jpg' className='icon_user' alt="" />
                  <div className='ml-2 line_height_user'>
                    <b>John</b> <br />
                    <small>Uk,Lodon</small>
                  </div>
                </div>
              </div>
            </div>
            ...
            {testimonials.map((testimonial, index) => (
              <div key={index} className="col-12 col-sm-12 col-md-6 col-lg-4">
                <div className="bgGray_about text-black p-4 mb-4">
                  ...
                  <p className="mt-4 mb-4 pb-4 borderbottom">{testimonial.feedback}</p>
                  <div className="d-flex align-items-center">
