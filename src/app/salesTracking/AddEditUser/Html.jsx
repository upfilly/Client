                        ...
                        <div className="form-container">
                            ...
                            <div className="form-row">
                                ...
                                <div className="col-md-6 mb-4">
                                    ...
                                    <input
                                        type="text"
                                        className={`form-control ${submitted && !form?.title ? 'is-invalid' : ''}`}
                                        value={form.title || ''}
                                ...
                                <div className="col-md-6 mb-4">
                                    ...
                                    <input
                                        type="text"
                                        className={`form-control ${submitted && !form?.amount ? 'is-invalid' : ''}`}
                                        value={form.amount || ''}
                                ...
                                <div className="col-md-6 mb-4">
                                    ...
                                    <input
                                        type="text"
                                        className={`form-control ${submitted && !form?.commission ? 'is-invalid' : ''}`}
                                        value={form.commission || ''}
                                        onChange={e => setform({ ...form, commission: e.target.value })}
                                        placeholder="0.00"
                                    />
                                    {submitted && !form?.commission && (
                                        <div className="invalid-feedback">Commission is required</div>
                                    )}
                                </div>
                                ...
                                <div className="col-md-6 mb-4">
                                    ...
                                    <input
                                        type="text"
                                        className={`form-control ${submitted && !form?.order_reference ? 'is-invalid' : ''}`}
                                        value={form.order_reference || ''}
                                        onChange={e => setform({ ...form, order_reference: e.target.value })}
                                        placeholder="Enter order reference"
                                    />
                                    {submitted && !form?.order_reference && (
                                        <div className="invalid-feedback">Order reference is required</div>
                                    )}
                                </div>
                                ...
                                <div className="col-md-6 mb-4">
                                    ...
                                    <input
                                        type="date"
                                        className={`form-control ${submitted && !form?.order_date ? 'is-invalid' : ''}`}
                                        value={form.order_date || ''}
                                        onChange={e => setform({ ...form, order_date: e.target.value })}
                                    />
                                    {submitted && !form?.order_date && (
                                        <div className="invalid-feedback">Order date is required</div>
                                    )}
                                </div>
                                ...
                                <div className="col-md-12 mb-4">
                                    ...
                                    <div className={`rich-text-editor ${submitted && !form?.description ? 'is-invalid' : ''}`}>
                                        <DynamicReactQuill
                                            theme="snow"
