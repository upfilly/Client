...
import Samplelegalterm from './Samplelegalterm';
...
const Affiliateprogrammanagement = ({ onAcceptTerms }) => {
  ...
  * Pop-up disclosures are prohibited.
  ...
  PAYMENT
  We use a third party to handle all of the tracking and payment. The third party platform is used to record all transactions and sales.
  As long as you remain a member of the program, we will pay your commission through the third party platform. You are responsible for ensuring your account information with the platform is accurate.
  Payments will be made approximately 30 days after the end of the month in which the sale occurred. Payments will be made by ACH or other agreed-upon method.
  If your commission is under $50, we will not pay out until you have reached $50 or more in commissions.
  GOVERNING LAW
  This Agreement shall be governed by and interpreted in accordance with the laws of the United States of America and the State of Delaware.
  MISCELLANEOUS
  ...
  3. This Agreement constitutes the entire agreement between you and us with respect to the subject matter herein and supersedes all prior or contemporaneous communications and proposals, whether oral or written between you and us.
  ...
  5. You may not assign this Agreement, by operation of law or otherwise, without our prior written consent.
  6. We may assign this Agreement without your consent.
  7. Neither party will be liable for any failure or delay due to matters beyond their reasonable control.
  8. Any notices under this Agreement will be sent by email to the addresses on file.
  ...
  `;
    ...
    const tabsData = [
        ...
        // { id: 'tab10', title: 'Support', content: 'This is the Support panel.' },
        // { id: 'tab11', title: 'Security', content: 'This is the Security panel.' },
        // { id: 'tab12', title: 'Themes', content: 'This is the Themes panel.' },
      ];
      ...
      return (
        <div className="w-full max-w-6xl mx-auto mt-10">
          {/* Tab buttons */}
          <div className="flex overflow-x-auto whitespace-nowrap space-x-2 pb-2 border-b">
            {tabsData.map((tab) => (
              <button
                key={tab.id}
                ...
                className={`px-4 py-2 rounded-t-md transition duration-200 ${
                  activeTab === tab.id
                    ? 'bg-white border-l border-t border-r border-gray-300 font-semibold text-blue-600'
          ...
          {/* Tab content */}
          <div className="p-6 bg-white border border-gray-300 rounded-b-md shadow-sm mt-0 overflow-x-auto">
