...
const formTransactionFields = [
    {
        label: "Does the transaction value that commissions are paid on include VAT? Sales Tax?",
        showInput: false,
    },
    {
        label: "Does the transaction value that commissions are paid on include Delivery charges?",
        showInput: false,
    },
    {
        label: "Does the transaction value that commissions are paid on include Credit card fees?",
        showInput: false,
    },
    {
        label: "Does the transaction value that commissions are paid on include gift wrapping or other service charges?",
        showInput: false,
    },
    {
        label: "Are commissions not paid out on some products or product categories?",
        showInput: false,
    },
