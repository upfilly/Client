                ...
                <div className='table_section'>
                    <div className="table-responsive ">
                        <table className="table table-striped table-width">
                            ...
                            <tbody>
                                {!loaging && filteredData && filteredData.map((itm, i) => {
                                    return <tr className='data_row' key={i}>
                                        ...
                                        <td className='table_dats'>
                                            <div className="action_icons">
                                                {isAllow('editAdmins') && permission('campaign_edit') && !itm.isArchive && (
                                                ...
                                                {isAllow('deleteAdmins') && permission('campaign_delete') && (
                                                    <a className='edit_icon edit-delete' onClick={() => deleteItem(itm.id || itm._id, itm)}>
                                                        <i className={`material-icons ${itm?.status == "accepted" ? 'delete' : 'diabled'}`} title={itm.isArchive ? 'Restore' : 'Archive'}>
                        ...
                        {!loaging && filteredData?.length === 0 ? <div className="py-3 text-center">No {activeTab === 'active' ? 'Active' : 'Archived'} Campaigns Found</div> : <></>}
                    </div>
                </div>
