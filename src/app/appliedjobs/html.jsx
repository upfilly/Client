                                ...
                                <table className="table table-striped  ">
                                    <thead className='table_head'>
                                        <tr className='heading_row'>
                                            ...
                                            <th scope="col" className='table_data' >Affiliate Type</th>
                                            <th scope="col" className='table_data' >E-mail</th>
                                            ...
                                            return <tr className='data_row' key={i}>
                                                ...
                                                >
                                                    ...
                                                    <div className='user_detail'>
                                                        <div className='user_name'>
                                                            <h4 className='user'>
                                                                {methodModel.capitalizeFirstLetter(itm?.affiliate_id_details?.fullName)}
                                                            </h4>
                                                        </div>
                                                    </div></td>
                                                ...
                                                <td className='table_dats d-flex '>
                                                    {itm?.status == 'pending' ? <div >
                                                        <button onClick={() => {
                                                            statusChange("accepted", itm?.affiliate_id || itm?.affiliate_id)
                                                            // Tracklogin(itm?.campaign_unique_id)
                                                        }} className="btn btn-primary mr-2">
                                                            <i className='fa fa-check'></i>
                                                        </button>
                                                        <button onClick={() => statusChange("rejected", itm?.affiliate_id)} className="btn btn-danger br50 bg-red mr-2">
