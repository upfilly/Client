...
const Users = () => {
  ...
  const statusChange = (itm, id) => {
    if (itm === 'accepted') {
      ...
      loader(true);
      ApiClient.put('brand/changerequeststatus', { status: itm, affiliate_id: id }).then((res) => {
        if (res.success) {
      ...
      Swal.fire({
        ...
        html: `
         <h2 style="" class="modal-title-main pt-0">Deny Request</h2>
