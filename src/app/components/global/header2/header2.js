                        ...
                        >
                          <div className="messagetext">
                            <div className="mb-3 bgblue">
                              ...
                              <span>
                                {itm?.type == "message" ? (
                                  <p className="noti_text_msg">
                                    You have a message from{" "}
                                    {itm?.addedBy_name?.slice(0, 10)}...
                                  </p>
                                ) : itm?.type == "campaign" ? (
                                  <p className="noti_text_chat">
