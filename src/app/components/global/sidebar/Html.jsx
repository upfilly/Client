    ...
    <div className="nav flex-column new-sidebar" component="siderbar">
      ...
      <div className="main-top">
            ...
            <div className="nav-item">
              <a className={`nav-link hoverclass affilate ${tabclass('affiliates') || tab == 'affiliates' ? '' : 'collapsed-m'}`} onClick={() => tabChange('affiliates')}
                data-bs-toggle="tooltip" data-bs-placement="top" title="Affiliate">
                  <svg className="text_black svg_iconbx" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
        ...
        {user?.role == "brand" && <>
          ...
          <i className="material-icons mr-2 svg_iconbx" title="campaignManagement">recent_actors</i>
        ...
        {user && user?.role == "affiliate" || user?.role == "team" && <ListItemLink to="/affiliateTeam" data-bs-toggle="tooltip" data-bs-placement="top" title="Add Offer" disabled={!user?.account_id && user?.role != 'team' ? true : false}>
          <i className="material-icons mr-2 svg_iconbx" title="product">groups_3</i>
       ...
       {user?.role != "team" && <ListItemLink to="/salesTracking" data-bs-toggle="tooltip" data-bs-placement="top" title="Add Offer" disabled={(!user?.account_id && user?.role === 'affiliate') ? true : false}>
          <i className="material-icons mr-2 svg_iconbx" title="untracked sales">
            real_estate_agent</i>
