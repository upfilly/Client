...
export default function Layout({ title, description, children , handleKeyPress, setFilter, reset ,filter ,name ,filters}: Props) {
  ...
  const isDashboard = pathname.includes('/mapping') || pathname.includes('/reports') || pathname.includes('/brand-report') || pathname.includes('/affiliate-report') || pathname.includes('/trackingData') || pathname.includes('/performance') || pathname.includes('/CreativeEmails') || pathname.includes('/EmailMessages') || pathname.includes('/DataFeeds') ||
