              ...
              <thead className="table_head">
                <tr className="heading_row">
                  <th
                    ...
                    onClick={(e) => sorting("templateName")}
                  >
                  ...
                  <th scope="col" className="table_data">
                    {user?.role == "affiliate" ? "Brand" : "Subject"}
                  </th>
                  <th
                    scope="col"
                    className="table_data"
                              ...
                              <h4 className="user">
                                {user?.role == "affiliate"
                                  ? methodModel.capitalizeFirstLetter(
                                      itm?.emailtemplate_details?.templateName
                                    )
                                  : methodModel.capitalizeFirstLetter(
                                      itm.templateName
                                    )}
