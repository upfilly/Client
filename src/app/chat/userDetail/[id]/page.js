                ...
                <div className="  card  ">
                    ...
                    <div className='card-header'>
                        <div className='main_title_head profile-card card_header'>
                            ...
                            <h3 className="  ">
                                <a to="/campaign" onClick={back}>  <i className="fa fa-arrow-left mr-2 " title='Back' aria-hidden="true"></i></a> <span> User Detail</span>
                            </h3>
                        ...
                        <div className='row'>
                            ...
                            <div className='col-sm-12 col-md-12'>
                                <div className='fetch_data'>
                                    {status?.length >= 1 && <div className='track_head' onClick={() => setShowStatus(!showStatus)}>
