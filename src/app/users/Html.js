                ...
                <div className=" all_bxbtns flex-wrap  gap-2 d-flex filterFlex phView align-items-center    justify-content-md-end">
                  ...
                  {(user?.role == "brand" ||
                    ...
                    <>
                      {" "}
                      <a
                        className="btn btn-primary add_users "
                        onClick={(e) => add()}
                      >
                    ...
                    <table className="table table-striped">
                      <thead className="table_head">
                        <tr className="heading_row">
                          ...
                          <th
                            onClick={(e) => sorting("role")}
                            scope="col"
                            className="table_data"
                          >
                            Role {filters?.sorder === "asc" ? "↑" : "↓"}
                          </th>
                          <th
                            ...
                            return (
                              <tr className="data_row" key={i}>
                                ...
                                <td>
                                  {(user?.role == "affiliate" ||
                                    user?.role == "brand" ||
                                    user?.permission_detail?.user_edit) && (
                                    <div className="action_icons ">
                                      {permission("user_edit") && (
                                        <a
                                          className="edit_icon action-btns edit-main"
                                          title="Edit"
                                          onClick={() => edit(itm.user_id)}
                                        >
                                          <i
                                      ...
                                      {(user?.role == "affiliate" ||
                                        ...
                                        >
                                          <i
                                            className={`material-icons delete user-action-delete-btn-icon `}
                                            title="Delete"
                                          >
                                            {" "}
                                            delete
